...
### 6、符合国内的UI风格。
### 7、支持前后端分离部署、同时也支持前后端合并在一起部署，部署方便，拉取镜像即可快速进行部署。
...
# 联系我们
### 拥有丰富的ThingsBoard使用实战经验，使用ThingsBoard做过很多的项目，对物联网和协议和业务场景非常熟悉。
### 目前国内对ThingsBoard理解和使用最全面的人都在我群里面，欢迎加入探讨，如果商业项目合作，请加群私信群主。
### qq群：594880091
